...
/*
	...
	$Id: db.class.php 12160 2008-01-16 01:35:59Z heyond $
*/
class db {
	var $querynum = 0;
	var $link;
	...
	function query($sql, $type = '', $cachetime = FALSE) {
		mysql_query("SET NAMES 'GBK'"); //Éè¶¨UC²éÑ¯±àÂëÎªGBK£¬±ÜÃâ±àÂë³åÍ»
		...
		$this->querynum++;
		$this->histories[] = $sql;
		mysql_query("SET NAMES 'utf8'");//»¹Ô­MWÏµÍ³²éÑ¯±àÂëÎªUTF-8£¬±ÜÃâ±àÂë³åÍ»
		return $query;
	}
